...
from app_material.views import (
...
urlpatterns = [
    ...
    path(
        'section/<str:slug>/', SectionRetrieveAPIView.as_view(), name='section-retrieve'
    ),
    path(
        'section/update/<str:slug>/',
        SectionUpdateAPIView.as_view(),
        name='section-update',
    ),
    path(
        'section/delete/<str:slug>/',
    ...
    path(
        'material/update/<str:slug>/',
        MaterialUpdateAPIView.as_view(),
        name='material-update',
    ),
    path(
        'material/delete/<str:slug>/',
