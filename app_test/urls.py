...
from app_test.views import QuizAPIView, TestCreateAPIView, TestListAPIView, TestAPIView, QuestionCreateAPIView, \
    QuestionListAPIView, QuestionAPIView, AnswerListAPIView, AnswerCreateAPIView, AnswerAPIView, TestTryListAPIView, \
    TestTryAPIView
